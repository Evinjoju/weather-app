...
const App = () => {
  ...
  return (
    <div className="App">
      <h3 className='head'>Whats the weather today?</h3>
      <input
        type="text"
      ...
      {weather && (
        <div className="card">
          <div className="weather-info">
            <h3 className='ev'>{weather.name}</h3>
            <p className='ev'>{weather.main.temp}°C</p>
            <p className='ev'>{weather.weather[0].description}</p>
          </div>
